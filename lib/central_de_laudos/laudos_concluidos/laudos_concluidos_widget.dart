...
import 'laudos_concluidos_model.dart';
export 'laudos_concluidos_model.dart';

class LaudosConcluidosWidget extends StatefulWidget {
  const LaudosConcluidosWidget({super.key});

  @override
  State<LaudosConcluidosWidget> createState() => _LaudosConcluidosWidgetState();
}

class _LaudosConcluidosWidgetState extends State<LaudosConcluidosWidget> {
  late LaudosConcluidosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LaudosConcluidosModel());
