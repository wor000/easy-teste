...
import 'laudos_em_andamento_widget.dart' show LaudosEmAndamentoWidget;
import 'package:flutter/material.dart';

class LaudosEmAndamentoModel extends FlutterFlowModel<LaudosEmAndamentoWidget> {
  ...
  // Stores action output result for [Backend Call - Query Rows] action in Laudos_em_Andamento widget.
