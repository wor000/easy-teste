...
import 'modal_editar_veterinario_model.dart';
export 'modal_editar_veterinario_model.dart';

class ModalEditarVeterinarioWidget extends StatefulWidget {
  const ModalEditarVeterinarioWidget({
    super.key,
    required this.vetRow,
  });

  final VeterinariosRow? vetRow;

  @override
  State<ModalEditarVeterinarioWidget> createState() =>
      _ModalEditarVeterinarioWidgetState();
}

class _ModalEditarVeterinarioWidgetState
    extends State<ModalEditarVeterinarioWidget> {
  late ModalEditarVeterinarioModel _model;
  ...
  void initState() {
    ...
    _model.inputBairroTextController1 ??=
        TextEditingController(text: widget.vetRow?.bairro);
    _model.inputBairroFocusNode1 ??= FocusNode();

    _model.inputCidadeTextController1 ??=
        TextEditingController(text: widget.vetRow?.cidade);
    _model.inputCidadeFocusNode1 ??= FocusNode();

    _model.inputUfTextController1 ??=
        TextEditingController(text: widget.vetRow?.uf);
    _model.inputUfFocusNode1 ??= FocusNode();

    _model.inputNomeVeterinarioTextController2 ??=
        TextEditingController(text: widget.vetRow?.nome);
    ...
    _model.inputEmailVeterinarioTextController2 ??=
        TextEditingController(text: widget.vetRow?.email);
            ...
            Expanded(
              child: Align(
                ...
                child: Padding(
                  ...
                  child: FutureBuilder<List<VeterinariosRow>>(
                    future: VeterinariosTable().querySingleRow(
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<VeterinariosRow> profileCardVeterinariosRowList =
                          snapshot.data!;

                      final profileCardVeterinariosRow =
                          profileCardVeterinariosRowList.isNotEmpty
                              ? profileCardVeterinariosRowList.first
                              : null;
                                                    ...
                                                    padding:
                                                        const EdgeInsetsDirectional
                                                            .fromSTEB(16.0, 0.0,
                                                                16.0, 0.0),
                                                    child: Text(
                                                      'Editar os dados do veterinário',
                                                      textAlign:
                                                          TextAlign.center,
                                                      style: FlutterFlowTheme
                                                              .of(context)
                                        ...
                                        child: Container(
                                          ...
                                          child: TextFormField(
                                            ...
                                            validator: _model
                                                ...
                                                .asValidator(context),
                                            inputFormatters: [
                                              _model.inputCpfVeterinarioMask1
                                            ],
                                          ),
                                        ),
                                      ),
                                        ...
                                        child: Container(
                                          ...
                                          child: TextFormField(
                                            ...
                                            validator: _model
                                                ...
                                                .asValidator(context),
                                            inputFormatters: [
                                              _model.inputCrmvVeterinarioMask1
                                            ],
                                          ),
                                        ),
                                      ),
                                      ...
                                      Container(
                                        ...
                                        child: SizedBox(
                                          ...
                                          child: TextFormField(
                                            controller:
                                                _model.inputUfTextController1,
                                            focusNode: _model.inputUfFocusNode1,
                                            obscureText: false,
                                            decoration: InputDecoration(
                                              labelText: 'UF',
                                              labelStyle:
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      FFButtonWidget(
                                        onPressed: () async {
                                          await VeterinariosTable().update(
                                            data: {
                                              'nome': _model
                                                  .inputNomeVeterinarioTextController1
                                                  .text,
                                              ...
                                              'telefone': _model
                                                  ...
                                                  .text,
                                              'cep': _model
                                                  .inputCepTextController1.text,
                                              'endereço': _model
                                                  .inputRuaTextController1.text,
                                              'bairro': _model
                                                  .inputBairroTextController1
                                                  .text,
                                              'cidade': _model
                                      ...
                                      Container(
                                        ...
                                        child: TextFormField(
                                          ...
                                          validator: _model
                                              ...
                                              .asValidator(context),
                                          inputFormatters: [
                                            _model.inputTelefoneVeterinarioMask2
                                          ],
                                        ),
                                      ),
                                    ].divide(const SizedBox(height: 16.0)),
                                          ...
                                          await VeterinariosTable().update(
                                            data: {
                                              ...
                                              'telefone': _model
                                                  ...
                                                  .text,
                                              'cep': _model
                                                  .inputCepTextController2.text,
                                              'endereço': _model
                                                  .inputRuaTextController2.text,
                                              'bairro': _model
                                                  .inputBairroTextController2
                                                  .text,
                                              'cidade': _model
