...
import 'modal_cadastrar_clinica_model.dart';
export 'modal_cadastrar_clinica_model.dart';

class ModalCadastrarClinicaWidget extends StatefulWidget {
  const ModalCadastrarClinicaWidget({super.key});

  @override
  State<ModalCadastrarClinicaWidget> createState() =>
      _ModalCadastrarClinicaWidgetState();
}

class _ModalCadastrarClinicaWidgetState
    extends State<ModalCadastrarClinicaWidget> {
  late ModalCadastrarClinicaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModalCadastrarClinicaModel());

    _model.inputNomeClinicaTextController1 ??= TextEditingController();
    _model.inputNomeClinicaFocusNode1 ??= FocusNode();

    _model.inputCnpjClinicaTextController1 ??= TextEditingController();
    _model.inputCnpjClinicaFocusNode1 ??= FocusNode();

    _model.inputEmailClinicaTextController1 ??= TextEditingController();
    _model.inputEmailClinicaFocusNode1 ??= FocusNode();

    _model.inputTelefoneClinicaTextController1 ??= TextEditingController();
    ...
    _model.inputNomeClinicaTextController2 ??= TextEditingController();
    _model.inputNomeClinicaFocusNode2 ??= FocusNode();

    _model.inputCnpjClinicaTextController2 ??= TextEditingController();
    _model.inputCnpjClinicaFocusNode2 ??= FocusNode();

    _model.inputEmailClinicaTextController2 ??= TextEditingController();
    _model.inputEmailClinicaFocusNode2 ??= FocusNode();

    _model.inputTelefoneClinicaTextController2 ??= TextEditingController();
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      FFButtonWidget(
                                        onPressed: () async {
                                          if ((_model.inputNomeClinicaTextController1.text != '') &&
                              ...
                              children: [
                                    ...
                                    Flexible(
                                      child: Container(
                                        ...
                                        child: TextFormField(
                                          ...
                                          focusNode: _model.inputCepFocusNode2,
                                          obscureText: false,
                                          decoration: InputDecoration(
                                            labelText: 'CEP',
                                            labelStyle:
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.inputBairroTextController2,
                                        focusNode: _model.inputBairroFocusNode2,
                                        obscureText: false,
                                        decoration: InputDecoration(
                                          labelText: 'Bairro',
                                          labelStyle:
                                    ...
                                    Container(
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.inputCidadeTextController2,
                                        focusNode: _model.inputCidadeFocusNode2,
                                        obscureText: false,
                                        decoration: InputDecoration(
                                          labelText: 'Cidade',
                                          labelStyle:
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    FFButtonWidget(
                                      onPressed: () async {
                                        if ((_model.inputNomeClinicaTextController2.text != '') &&
