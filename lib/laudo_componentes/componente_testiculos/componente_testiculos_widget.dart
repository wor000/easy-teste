...
import 'componente_testiculos_model.dart';
export 'componente_testiculos_model.dart';

class ComponenteTesticulosWidget extends StatefulWidget {
  const ComponenteTesticulosWidget({super.key});

  @override
  State<ComponenteTesticulosWidget> createState() =>
      _ComponenteTesticulosWidgetState();
}

class _ComponenteTesticulosWidgetState
    extends State<ComponenteTesticulosWidget> {
  late ComponenteTesticulosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ComponenteTesticulosModel());
