...
import 'componente_pancreas_model.dart';
export 'componente_pancreas_model.dart';

class ComponentePancreasWidget extends StatefulWidget {
  const ComponentePancreasWidget({super.key});

  @override
  State<ComponentePancreasWidget> createState() =>
      _ComponentePancreasWidgetState();
}

class _ComponentePancreasWidgetState extends State<ComponentePancreasWidget> {
  late ComponentePancreasModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ComponentePancreasModel());
