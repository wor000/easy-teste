...
import 'componente_figado_model.dart';
export 'componente_figado_model.dart';

class ComponenteFigadoWidget extends StatefulWidget {
  const ComponenteFigadoWidget({super.key});

  @override
  State<ComponenteFigadoWidget> createState() => _ComponenteFigadoWidgetState();
}

class _ComponenteFigadoWidgetState extends State<ComponenteFigadoWidget> {
  late ComponenteFigadoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ComponenteFigadoModel());
