...
import 'componente_rins_model.dart';
export 'componente_rins_model.dart';

class ComponenteRinsWidget extends StatefulWidget {
  const ComponenteRinsWidget({super.key});

  @override
  State<ComponenteRinsWidget> createState() => _ComponenteRinsWidgetState();
}

class _ComponenteRinsWidgetState extends State<ComponenteRinsWidget> {
  late ComponenteRinsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ComponenteRinsModel());
