...
import 'componente_dimensao_biliar_model.dart';
export 'componente_dimensao_biliar_model.dart';

class ComponenteDimensaoBiliarWidget extends StatefulWidget {
  const ComponenteDimensaoBiliarWidget({super.key});

  @override
  State<ComponenteDimensaoBiliarWidget> createState() =>
      _ComponenteDimensaoBiliarWidgetState();
}

class _ComponenteDimensaoBiliarWidgetState
    extends State<ComponenteDimensaoBiliarWidget> {
  late ComponenteDimensaoBiliarModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ComponenteDimensaoBiliarModel());
