...
import 'componente_linfonodos_model.dart';
export 'componente_linfonodos_model.dart';

class ComponenteLinfonodosWidget extends StatefulWidget {
  const ComponenteLinfonodosWidget({super.key});

  @override
  State<ComponenteLinfonodosWidget> createState() =>
      _ComponenteLinfonodosWidgetState();
}

class _ComponenteLinfonodosWidgetState
    extends State<ComponenteLinfonodosWidget> {
  late ComponenteLinfonodosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ComponenteLinfonodosModel());
