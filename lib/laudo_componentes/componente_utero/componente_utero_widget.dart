...
import 'componente_utero_model.dart';
export 'componente_utero_model.dart';

class ComponenteUteroWidget extends StatefulWidget {
  const ComponenteUteroWidget({super.key});

  @override
  State<ComponenteUteroWidget> createState() => _ComponenteUteroWidgetState();
}

class _ComponenteUteroWidgetState extends State<ComponenteUteroWidget> {
  late ComponenteUteroModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ComponenteUteroModel());
